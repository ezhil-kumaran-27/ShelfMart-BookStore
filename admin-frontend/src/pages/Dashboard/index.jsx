...
import { Users, Package, DollarSign, BookOpen, Check, X, Truck, LogOut, Shield } from 'lucide-react';
...
const Dashboard = () => {
  ...
  if (loading) return <div className="min-h-screen bg-gray-50 flex justify-center items-center"><div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-indigo-600"></div></div>;
      ...
      <nav className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-2 text-indigo-600 font-bold text-xl">
            <img src="/logo.jpg" alt="ShelfMart Logo" className="h-8 w-auto object-contain rounded" />
            <span>ShelfMart Admin</span>
          </div>
          <button 
            onClick={handleLogout}
            className="flex items-center space-x-2 text-gray-500 hover:text-red-600 transition-colors font-medium px-3 py-2 rounded-md hover:bg-red-50"
          >
